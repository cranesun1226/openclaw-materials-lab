  ...
  it("registers services, tools, CLI, and approval hooks", () => {
    ...
    expect(toolRegistrations).toEqual(
      expect.arrayContaining([
        ...
        { name: "materials_search_literature", optional: false },
        { name: "materials_ingest_evidence", optional: false },
        { name: "materials_evaluate_research_claim", optional: false },
        { name: "materials_close_evidence_gaps", optional: false },
